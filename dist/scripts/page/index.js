...
define('widget/blurb/main',[],function(){
...
define('widget/parallaxscroll/main',['jquery', "detect"], function($, detect) {
...
define('text!widget/howitworks/index.html',[],function () { return '<div class="howitworks pop out row-fluid">\n    <ul class="hor txtalign-c">\n        <li class="howitworks-search span4">\n            <div class="howitworks-pic">\n                <div class="howitworks-item opensans">Search</div>\n            </div>\n            <p class="opensans">\n                <strong>100K</strong> suppliers<br>\n                <strong>One Million</strong> products\n            </p>\n        </li>\n        <li class="howitworks-filter span4">\n            <div class="howitworks-pic">\n                <div class="howitworks-item opensans">Filter</div>\n            </div>\n            <p class="opensans">\n                Social Networks, References, Colleagues, Ratings, Public Trade History\n            </p>\n        </li>\n        <li class="howitworks-find span4">\n            <div class="howitworks-pic">\n                <div class="howitworks-item opensans">Find</div>\n            </div>\n            <p class="opensans">\n                <strong>7</strong><br> Qualified Suppliers\n            </p>\n        </li>\n    </ul>\n    <a class="howitworks-close">close</a>\n</div>';});

define('widget/howitworks/main',['jquery', 'jquery.scrollto', "text!./index.html"], function($, $scrollto, template) {
...
*/
define('widget/header/main',['jquery'], function ($) {
